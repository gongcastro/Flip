...
data %>%
  ...
  ggsave(here("Figures", "HPP2", "01_lookingtimes-study-2.png"), height = 6, width = 12)
...
data.frame(
  ...
  ggsave(here("Figures", "HPP2", "04_model-assumptions-homoskedasticity-2.png"),width=10,height=5)

#### 11. Export results ########################################################
# 11.a. Export results from Item-dummy-coded model (baseline on familiar trials)
write.table(data, here("Data", "HPP2", "01_data-processed-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(anova, here("Data", "HPP2", "02_results-lmem-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(effects, here("Data", "HPP2", "02_results-effects-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(fitted, here("Data", "HPP2", "02_results-fitted-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(multicollinearity, here("Data", "HPP2", "02_results-multicollinearity-2.csv"), sep = ",", dec = ".", row.names = FALSE)
# 11.b. Export results from Item-effect-coded model
write.table(data, here("Data", "HPP2", "Effect-coding", "01_data-processed-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(anova.effect, here("Data", "HPP2", "Effect-coding", "02_results-lmem-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(effects.effect, here("Data", "HPP2", "Effect-coding", "02_results-effects-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(fitted.effect, here("Data", "HPP2", "Effect-coding", "02_results-fitted-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(multicollinearity.effect, here("Data", "HPP2", "Effect-coding", "02_results-multicollinearity-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
# 11.c. Export results from Item-dummy-coded model (baseline on novel trials)
write.table(data, here("Data", "HPP2", "Dummy-coding-Novel", "01_data-processed-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(anova.novel, here("Data", "HPP2", "Dummy-coding-Novel", "02_results-lmem-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(effects.novel, here("Data", "HPP2", "Dummy-coding-Novel", "02_results-effects-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(fitted.novel, here("Data", "HPP2", "Dummy-coding-Novel", "02_results-fitted-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(multicollinearity.novel, here("Data", "HPP2", "Dummy-coding-Novel", "02_results-multicollinearity-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
