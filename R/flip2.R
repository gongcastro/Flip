...
write.table(dat, here("Data", "HPP2", "01_data-processed-2.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(dat, here("Data", "HPP2", "Effect-coding", "01_data-processed-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(dat, here("Data", "HPP2", "Dummy-coding-Novel", "01_data-processed-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
