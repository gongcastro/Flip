...
ggplot(dat_diff_hpp, aes(hpp, mean_novelty_preference)) +
  ...
  ggsave(here("Figures", "HPP2", "02_interaction-2.png"), width = 15) +
  ggsave(here("Figures", "HPP2", "02_interaction-2.pdf"), width = 15) 
...
write.table(predictions, here("Data", "HPP2", "02_results-effects-2.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(predictions.effect, here("Data", "HPP2", "Effect-coding", "02_results-effects-effect-2.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(predictions.novel, here("Data", "HPP2", "Dummy-coding-Novel", "02_results-effects-novel-2.csv"), sep = ",", dec = ".", row.names = FALSE)
