...
ggplot(data = fitted, aes(x = HPP, y = LookingTime,
  ...
  ggsave(here("Figures", "HPP3", "03_interaction-3.png"), width = 7, height = 5) +
  ggsave(here("Figures", "HPP3", "03_interaction-3.pdf"), width = 7, height = 5)
...
write.table(fitted, here("Data", "HPP3", "02_results-fitted-3.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(effects.effect, here("Data", "HPP3", "Effect-coding", "02_results-effects-effect-3.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(fitted.effect, here("Data", "HPP3", "Effect-coding", "02_results-fitted-effect-3.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(multicollinearity.effect, here("Data", "HPP3", "Effect-coding", "02_results-multicollinearity-effect-3.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(effects.novel, here("Data", "HPP3", "Dummy-coding-Novel", "02_results-effects-novel-3.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(fitted.novel, here("Data", "HPP3", "Dummy-coding-Novel", "02_results-fitted-novel-3.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(multicollinearity.novel, here("Data", "HPP3", "Dummy-coding-Novel", "02_results-multicollinearity-novel-3.csv"), sep = ",", dec = ".", row.names = FALSE)
