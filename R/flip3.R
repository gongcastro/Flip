...
write.table(dat, here("Data", "HPP3", "01_data-processed-3.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(dat, here("Data", "HPP3", "Effect-coding", "01_data-processed-effect-3.csv"), sep = ",", dec = ".", row.names = FALSE)
...
write.table(dat, here("Data", "HPP3", "Dummy-coding-Novel", "01_data-processed-novel-3.csv"), sep = ",", dec = ".", row.names = FALSE)
