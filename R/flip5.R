...
ggplot(study_data, aes(item, looking_time, fill = item)) +
  ...
  ggsave(here("Figures", "HPP5", "01_lookingtimes-study-4.png"), height = 6, width = 12)
...
write.table(dat, here("Data", "HPP5", "01_data-processed-5.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(anova, here("Data", "HPP5", "02_results-lmem-5.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(predictions, here("Data", "HPP5", "02_results-effects-5.csv"), sep = ",", dec = ".", row.names = FALSE)
# 11.b. Export results from Item-effect-coded model
write.table(dat, here("Data", "HPP5", "Effect-coding", "01_data-processed-effect-5.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(anova.effect, here("Data", "HPP5", "Effect-coding", "02_results-lmem-effect-5.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(predictions.effect, here("Data", "HPP5", "Effect-coding", "02_results-effects-effect-5.csv"), sep = ",", dec = ".", row.names = FALSE)
# 11.c. Export results from Item-dummy-coded model (baseline on novel trials)
write.table(dat, here("Data", "HPP5", "Dummy-coding-Novel", "01_data-processed-novel-5.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(anova.novel, here("Data", "HPP5", "Dummy-coding-Novel", "02_results-lmem-novel-5.csv"), sep = ",", dec = ".", row.names = FALSE)
write.table(predictions.novel, here("Data", "HPP5", "Dummy-coding-Novel", "02_results-effects-novel-5.csv"), sep = ",", dec = ".", row.names = FALSE)
