...
```{r coefficients, echo=FALSE, fig.align="c", message=FALSE, warning=FALSE, fig.cap="Coefficients of the model. Black dots and error bars indicate the coefficient and SEM estimated by the frequentist model. Grey boxes indicate the 95% confidence intereval. Black diamonds and grey error bars indicate the coefficient and 95% credible intervals estimated by the bayesian model."}
